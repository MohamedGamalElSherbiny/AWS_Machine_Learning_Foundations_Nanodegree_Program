...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.bar(x=['0', '1'], y=[(1 - self.p) * self.n, self.n])
    ...
    def pdf(self, k):
        ...
        return (math.factorial(self.n)/ (math.factorial(k) * math.factorial(self.n - k))) * self.p**self.n *\
               (1 - self.p)**(self.n - k)
